...
public class MoveTask extends Task<MoveWork> implements Serializable {
  ...
  private void moveFile(Path sourcePath, Path targetPath, boolean isDfsDir)
    ...
    if (isDfsDir) {
      ...
      // 需要从-ext-10002 移动到-ext-10000  Moving data to: file:/tmp/hive-root/hive_2014-07-31_02-21-45_332_2912688879867288853-1/-ext-10000 from file:/tmp/hive-root/hive_2014-07-31_02-21-45_332_2912688879867288853-1/-ext-10002
      // delete the output directory if it already exists
      fs.delete(targetPath, true);// /tmp/hive-root/hive_2014-07-28_05-44-12_557_5904541063958286177-1/-ext-10000
      ...
      if (fs.exists(sourcePath)) {
        ...
        if (!fs.rename(sourcePath, targetPath)) {//改成 -ext-10000 啦
          try {
            if (deletePath != null) {
