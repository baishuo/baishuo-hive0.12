...
public class LoadSemanticAnalyzer extends BaseSemanticAnalyzer {
  ...
  public void analyzeInternal(ASTNode ast) throws SemanticException {
    ...
    URI toURI = (ts.partHandle != null) ? ts.partHandle.getDataLocation()
        : ts.tableHandle.getDataLocation();// file:/user/hive/warehouse/partition_test

    List<FieldSchema> parts = ts.tableHandle.getPartitionKeys();// [FieldSchema(name:stat_date, type:string, comment:null), FieldSchema(name:province, type:string, comment:null)]
