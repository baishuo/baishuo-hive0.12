...
public class QB {
  ...
  private HashMap<String, String> aliasToTabs; // 表的别名
  private HashMap<String, QBExpr> aliasToSubq; // 子查询的别名
  private HashMap<String, Map<String, String>> aliasToProps; //
  private List<String> aliases; // 各种别名
  private QBParseInfo qbp;
  private QBMetaData qbm; // 元数据
  private QBJoinTree qbjoin; // join
  private String id;
  private boolean isQuery; // 是不是查询
