...
import java.util.concurrent.ConcurrentHashMap;import org.apache.commons.logging.LogFactory;import org.apache.commons.logging.Log;
...
public final class TypeInfoUtils {
  static final private Log LOG = LogFactory.getLog(TypeInfoUtils.class.getName());
  ...
  public static ObjectInspector getStandardWritableObjectInspectorFromTypeInfo(
      TypeInfo typeInfo) {// System.out.println("cachedStandardObjectInspector:" + cachedStandardObjectInspector);
    ObjectInspector result = cachedStandardObjectInspector.get(typeInfo); LOG.info("result:" + result + "|typeinfo:" + typeInfo + "|cachedStandardObjectInspector:"+ cachedStandardObjectInspector.size());
    if (result == null) { 
      ...
      cachedStandardObjectInspector.put(typeInfo, result);LOG.info("cachedStandardObjectInspector.size():" + cachedStandardObjectInspector.size());
    }
    return result;
  }
  ...
  public static ObjectInspector getStandardJavaObjectInspectorFromTypeInfo(
      TypeInfo typeInfo) {System.out.println("---java----");
